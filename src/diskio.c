...
SPI_TypeDef *sd = SPI1; // the SPI interface to use for the SD cardc:\Users\Reggi\lab-7-usart-Bunga-byte\src\ff.c c:\Users\Reggi\lab-7-usart-Bunga-byte\include\ff.h
